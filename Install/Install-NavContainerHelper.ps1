Param(
    [Parameter(Mandatory=$false)] [string] $navContainerHelperPath = $env:navContainerHelperPath,
    [Parameter(Mandatory=$false)] [string] $navContainerHelperVersion = $env:navContainerHelperVersion
)

if (-not $navContainerHelperVersion) { $navContainerHelperVersion = "latest" }

Write-Host "Updating NavContainerHelper to version $navContainerHelperVersion"
